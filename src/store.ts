...
interface Todos {
    ...
    updateTodoById: (userId: number, id: number, todo: Partial<Todo>) => Todo | undefined;
...
interface SharedTodos {
    ...
    updateSharedTodoById: (userId: number, id: number, sharedTodo: Partial<SharedTodo>) => void;
...
export { useTodos, useUsers, useSharedTodos, useUIStore, useFilterStore, useSearchStore, useUserStore };
